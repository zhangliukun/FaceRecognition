...
*/
    ...
    Mat topLeftOfFace = face(Rect(leftX, topY, widthX, heightY));//left part face
    Mat topRightOfFace = face(Rect(rightX, topY, widthX, heightY));//right part face
...
Mat getPreprocessedFace(Mat &srcImg, int desiredFaceWidth, CascadeClassifier &faceCascade, CascadeClassifier &eyeCascade1, CascadeClassifier &eyeCascade2, bool doLeftAndRightSeparately, Rect *storeFaceRect, Point *storeLeftEye, Point *storeRightEye, Rect *searchedLeftEye, Rect *searchedRightEye)
{
    ...
    Rect faceRect;
    detectLargestObject(srcImg, faceCascade, faceRect);//[hujiawei]
    ...
    if (faceRect.width > 0) {
        ...
        if (leftEye.x >= 0 && rightEye.x >= 0) {
            ...
            imwrite("/mnt/sdcard/xface/sample_1warped.jpg", warped);//hujiawei
            ...
            imwrite("/mnt/sdcard/xface/sample_2equalized.jpg", warped);//hujiawei
            //imshow("equalized", warped);

            // Use the "Bilateral Filter" to reduce pixel noise by smoothing the image, but keeping the sharp edges in the face.
            Mat filtered = Mat(warped.size(), CV_8U);
            bilateralFilter(warped, filtered, 0, 20.0, 2.0);
            imwrite("/mnt/sdcard/xface/sample_3filtered.jpg", filtered);//hujiawei
            ...
            //imwrite("/mnt/sdcard/xface/sample_mask.jpg", mask);//hujiawei
            //imshow("mask", mask);
            ...
            */
            ...
            imwrite("/mnt/sdcard/xface/sample_4masked.jpg", dstImg);//hujiawei
            //imshow("dstImg", dstImg);
