...
import zalezone.base.BaseActivity;
...
//						ToastUtil.showShortToast(getApplicationContext(), "add image fail!");
                        ...
                        ToastUtil.showShortToast(getApplicationContext(), "人脸图片保存成功：" + count);
                        count++;
                    }
                    ...
                    if (result == 0) {
                        ...
                        ToastUtil.showShortToast(getApplicationContext(), "初始化成功");
                    }
                }
